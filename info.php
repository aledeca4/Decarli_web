...
<head>
    ...
    <title>Informazioni PHP - ALESSANDRO DE CARLI</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per ALESSANDRO DE CARLI</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> ALESSANDRO DE CARLI</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> decarli.alessandro</p>
